...
public class TournamentAddUsers extends MainCommand<Tournament>{
  ...
  public TournamentAddUsers(TournamentRepository tournamentRepository, TournamentArrayRepository tournamentArrayRepository,UserRepository userRepository, User o, int id){
